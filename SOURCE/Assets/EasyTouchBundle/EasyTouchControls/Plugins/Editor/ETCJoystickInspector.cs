	...
	public override void OnInspectorGUI(){
		...
		if (t.showPSInspector){
			ETCGuiTools.BeginGroup();{
				...
				// Area sprite ratio
				Rect rect =  t.GetComponent<UnityEngine.UI.Image>().sprite.rect;
				...
				// Thumb sprite ratio
				rect = t.thumb.GetComponent<UnityEngine.UI.Image>().sprite.rect;
		...
		if (t.showSpriteInspector){
			ETCGuiTools.BeginGroup();{
				#region Background
				Sprite areaSprite = t.GetComponent<UnityEngine.UI.Image>().sprite;
				
				EditorGUILayout.BeginHorizontal();
				t.GetComponent<UnityEngine.UI.Image>().sprite = (Sprite)EditorGUILayout.ObjectField("Background",t.GetComponent<UnityEngine.UI.Image>().sprite,typeof(Sprite),true,GUILayout.MinWidth(100));
				t.GetComponent<UnityEngine.UI.Image>().color = EditorGUILayout.ColorField("",t.GetComponent<UnityEngine.UI.Image>().color,GUILayout.Width(50));
				...
				ETCGuiTools.DrawTextureRectPreview( lastRect,spriteRect,t.GetComponent<UnityEngine.UI.Image>().sprite.texture,Color.white);
				#endregion
				EditorGUILayout.Space();
				#region thumb
				Sprite thumbSprite = t.thumb.GetComponent<UnityEngine.UI.Image>().sprite;
				
				EditorGUILayout.BeginHorizontal();
				t.thumb.GetComponent<UnityEngine.UI.Image>().sprite = (Sprite)EditorGUILayout.ObjectField("Thumb",t.thumb.GetComponent<UnityEngine.UI.Image>().sprite,typeof(Sprite),true,GUILayout.MinWidth(100));
				t.thumb.GetComponent<UnityEngine.UI.Image>().color = EditorGUILayout.ColorField("",t.thumb.GetComponent<UnityEngine.UI.Image>().color,GUILayout.Width(50));
				EditorGUILayout.EndHorizontal();
				...
				ETCGuiTools.DrawTextureRectPreview( lastRect,spriteRect,t.thumb.GetComponent<UnityEngine.UI.Image>().sprite.texture,Color.white);
