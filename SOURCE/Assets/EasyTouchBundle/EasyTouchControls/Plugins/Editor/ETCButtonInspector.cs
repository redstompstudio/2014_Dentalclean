	...
	public override void OnInspectorGUI(){
		...
		if (t.showPSInspector){
			ETCGuiTools.BeginGroup();{
				...
				// Area sprite ratio
				if (t.GetComponent<UnityEngine.UI.Image>().sprite != null){
		...
		if (t.showSpriteInspector){
			ETCGuiTools.BeginGroup();{
				...
				if (EditorGUI.EndChangeCheck ()) {
					t.GetComponent<UnityEngine.UI.Image>().sprite = t.normalSprite;
					t.GetComponent<UnityEngine.UI.Image>().color = t.normalColor;
				}
